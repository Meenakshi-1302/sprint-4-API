...
public class Offer {
	...
	@Lob
	@Column(length = 100000000)
	private byte[] candidateOfferLetter;
	...
	public byte[] getCandidateOfferLetter() {
		return candidateOfferLetter;
	}

	public void setCandidateOfferLetter(byte[] candidateOfferLetter) {
		this.candidateOfferLetter = candidateOfferLetter;
	}
